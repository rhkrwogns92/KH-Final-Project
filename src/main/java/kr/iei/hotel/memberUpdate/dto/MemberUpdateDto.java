package kr.iei.hotel.memberUpdate.dto;
...
public class MemberUpdateDto {
	...
	public MemberUpdateDto(String memberRole, String memberEmail, String memberKey) {
		this.memberRole = memberRole;
		this.memberEmail = memberEmail;
		this.memberKey = memberKey;
	}

	public MemberUpdateDto(Long memberNumber, String memberGrade, Date memberRegDate, Date memberUnRegDate,
	...
	public String toString() {
		return "MemberUpdateDto [no=" + no + ", memberNumber=" + memberNumber + ", memberGrade=" + memberGrade
